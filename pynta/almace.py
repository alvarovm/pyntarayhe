...
def set_ALMACE(file_xyz, work_dir, storage, fileConfig, sub_calc, sub_calc_kwargs_yaml):

    config = read_yaml(fileConfig)
...
if  __name__ == "__main__":
    ...
    if len(sys.argv) == 7:
        ...
        almace = set_ALMACE(sys.argv[1], work_dir, storage, config, sub_calc, sub_calc_kwargs_yaml)
